...
//  Today
//
//  Created by Rafael Perez on 05/12/22.
//
...
class ReminderViewController: UICollectionViewController {
    ...
    private func updateSnapshotForEditing() {
        ...
        let title = reminder.title.isEmpty ? "\"Reminder's title\"" : reminder.title
        snapshot.appendItems([.header(Section.title.name), .editText(title)], toSection: .title)
